...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::plan_structure::update_plan,
            commands::plan_structure::reorder_plan,
            commands::plan_structure::archive_plan,
            commands::plan_structure::restore_plan,
            commands::plan_structure::migrate_legacy_plan_archives,
            ...
            commands::plan_structure::reorder_checklist_item,
            commands::plan_structure::create_task,
            commands::plan_structure::create_checklist_item,
            commands::plan_structure::move_task,
            commands::plan_structure::delete_stage,
            commands::plan_structure::delete_task,
            commands::plan_structure::delete_checklist_item,
