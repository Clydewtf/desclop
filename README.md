...
The current release line is `v0.1.0-alpha.3`, focused on comfortable daily personal work and clarity across several plans. Expect rough edges, missing polish, and possible changes to workflows while the product shape is still settling.
